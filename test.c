...
static const int BATCH_STEPS = 1000;

static double seconds(clock_t t1, clock_t t0)
{
	return ((double) (t1 - t0)) / CLOCKS_PER_SEC;
}

static double verify_test_case(const struct test_case_t *const tcase, int quiet)
{
	clock_t t = clock();
